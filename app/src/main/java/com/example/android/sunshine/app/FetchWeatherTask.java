...
//        Log.v(LOG_TAG + " tests", mContext.toString());
        // mContext: com.example.android.sunshine.app.MainActivity@4236d5b0
        // mContext: com.example.android.sunshine.app.MainActivity@4236dd78
        // ...

//        Log.v(LOG_TAG + " tests", WeatherContract.LocationEntry.CONTENT_URI.toString());
...
//            throws JSONException {
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            /**
             * delete all rows in weather table
...
//            Log.v(LOG_TAG + " test", url.toString());
